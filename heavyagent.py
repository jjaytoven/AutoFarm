...
def main():
    while True:
        ...
        # 4) Heavy place
        click_image(heavy, clicks=2, scale=scale, duration=0.2)
        click_image(heavy, clicks=2, scale=scale, duration=0.2)

        # 5) Agent
        click_image(agent, clicks=3, scale=scale, duration=0.2)
        ...
        # 8) Back of agent
        click_image(agent_back, clicks=1, scale=scale, duration=0.2)
