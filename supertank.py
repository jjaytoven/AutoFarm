...
def main():
    while True:
        ...
        pyautogui.mouseDown(1361.5, 819.0)
        pyautogui.dragTo(171.0, 842.5, button='left')
        pyautogui.mouseUp(171.0, 842.5)
        ...
        click_image(available, clicks=1, scale=scale, duration=0.2)

        click_image(vehicles, clicks=1, scale=scale, duration=0.2)

        click_image(supertank, clicks=3, scale=scale, duration=0.2)
